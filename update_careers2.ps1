$content = Get-Content -Raw "careers.html"
$newForm = @"
    <section id="application-form" style="padding: 5rem 0; background-color: var(--bg-color);">
        <div class="container">
...
$content = $content -replace '(?s)<section id="application-form".*?<!-- Careers Page Specific FAQs -->', "`$newForm`n`n    <!-- Careers Page Specific FAQs -->"

[IO.File]::WriteAllText("careers.html", $content)
Write-Host "Updated careers.html"
